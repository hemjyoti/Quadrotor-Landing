...
void tau(double x_d, double y_d, double z0)
{
	...
	do{
		...
		if(z>0.1 || i<2)
		{
			...
			lx = - Kd*0.2*(drone_navdata.vx*0.001-dxg) - Kp*0.8*(x-xg);    ///changed kd from 0.3
			ly = - Kd*0.2*(drone_navdata.vy*0.001-dyg) - Kp*0.8*(y-yg);
			lz = -((0.7)*(z-zg));
